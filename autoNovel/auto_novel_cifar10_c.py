...
from data.cifar_corrupt_loader import CIFAR10Loader, CIFAR10LoaderMix, CIFAR100Loader, CIFAR100LoaderMix
...
if __name__ == "__main__":
    ...
    parser.add_argument('--rampup_length', default=50, type=int)  # Ramp-up length passed to ramps.py function
    parser.add_argument('--rampup_coefficient', type=float, default=5.0)  # Ramp-up coefficient
    ...
    parser.add_argument('--exp_root', type=str, default='./data/experiments/cifar_c/')  # Directory to save the resulting files
    parser.add_argument('--warmup_model_dir', type=str,default='data/experiments/cifar_c/supervised_learning/resnet_rotnet.pth')  # Directory to find the supervised pretrained model
    ...
    if logging_on:
        ...
        wandb.init(project="autonovel", entity="jacopodona", config=config, save_code=True)

...
class GenericDataset_mnisit_basline(data.Dataset):
...
class DataLoader_mnisit_baseline(object):
    def __init__(self,
                 dataset,
                 batch_size=1,
                 unsupervised=True,
...
if __name__ == '__main__':
    ...
    dataset_name_2=GenericDataset_mnisit_basline('mnisitm',split='test')

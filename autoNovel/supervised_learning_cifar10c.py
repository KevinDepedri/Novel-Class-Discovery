...
from data.cifar_corrupt_loader import CIFAR10Loader, CIFAR100Loader
...
if __name__ == "__main__":
    ...
    parser.add_argument('--rotnet_dir', type=str, default='./data/experiments/selfsupervised_learning/rotnet.pth')  # Directory to find the semi-supervised pretrained model
